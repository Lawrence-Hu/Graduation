...
public interface ProductInterface {
   ...
   // JsonData updateHotById(Integer id,Integer type);
    ...
    JsonData updateProductStatusById(String id,Boolean type);//修改审核状态

    //is接口查询 用于查询某些接口
    Boolean findIsSaleById(String id);
    Boolean findIsBestById(String id);
    Boolean findIsNewById(String id);
    Boolean findIsRecomById(String id);
    JsonData findProductStatusById(String id);
